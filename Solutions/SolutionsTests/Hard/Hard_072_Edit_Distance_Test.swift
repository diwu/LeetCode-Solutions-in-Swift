...
class Hard_072_Edit_Distance_Test: XCTestCase {
    ...
    private func asyncHelper(input input: [String], expected: Int) {
        weak var expectation: XCTestExpectation? = self.expectationWithDescription(Hard_072_Edit_Distance_Test.TimeOutName)
        ...
        waitForExpectationsWithTimeout(Hard_072_Edit_Distance_Test.TimeOut) { (error: NSError?) -> Void in
            if error != nil {
