...
class Medium_003_Longest_Substring_Without_Repeating_Characters_Test: XCTestCase {
    func testCase001() {
        let v = Medium_003_Longest_Substring_Without_Repeating_Characters.longest("abcabcdzaba")
        XCTAssert(v == 5, "Medium_003_Longest_Substring_Without_Repeating_Characters_Test #1")
    }

    func testCase002() {
        let v = Medium_003_Longest_Substring_Without_Repeating_Characters.longest("aaaa")
        XCTAssert(v == 1, "Medium_003_Longest_Substring_Without_Repeating_Characters_Test #2")
    }

    func testCase003() {
        let v = Medium_003_Longest_Substring_Without_Repeating_Characters.longest("aaabbbc")
        XCTAssert(v == 2, "Medium_003_Longest_Substring_Without_Repeating_Characters_Test #3")
    }

    func testCase004() {
        let v = Medium_003_Longest_Substring_Without_Repeating_Characters.longest("")
