...
class Medium_098_Validate_Binary_Search_Tree_Test: XCTestCase {
    ...
    private func asyncHelper(input input: [Int], expected: Bool) {
        weak var expectation: XCTestExpectation? = self.expectationWithDescription(Medium_098_Validate_Binary_Search_Tree_Test.TimeOutName)
        ...
        waitForExpectationsWithTimeout(Medium_098_Validate_Binary_Search_Tree_Test.TimeOut) { (error: NSError?) -> Void in
            if error != nil {
