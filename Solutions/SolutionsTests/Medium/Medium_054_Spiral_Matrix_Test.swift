...
class Medium_054_Spiral_Matrix_Test: XCTestCase {
    ...
    func test_001() {
        ...
        var expected: [Int] = [1,2,3,6,9,8,7,4,5]
    ...
    func test_002() {
        ...
        var expected: [Int] = [1,2,3,6,9,12,11,10,7,4,5,8]
        asyncHelper(input: input, expected: expected)
    }
    func test_003() {
        var input: [[Int]] = [
        ...
        var expected: [Int] = [1,2,3,4,8,12,11,10,9,5,6,7]
        asyncHelper(input: input, expected: expected)
    }
    func test_004() {
        var input: [[Int]] = [
    ...
    private func asyncHelper(# input: [[Int]], expected: [Int]) {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), { () -> Void in
            var result = Medium_054_Spiral_Matrix.spiralOrder(input)
