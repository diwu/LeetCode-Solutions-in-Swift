...
class Medium_092_Reverse_Linked_List_II_Test: XCTestCase, SolutionsTestCase {
    ...
    private func objc_helper1(_ intArray: [Int]) -> ObjC_Node? {
    ...
    private func objc_helper2(_ head: ObjC_Node?) -> [Int] {
        var res: [Int] = []
        var localHead = head
        while localHead != nil {
            res.append(localHead!.value)
